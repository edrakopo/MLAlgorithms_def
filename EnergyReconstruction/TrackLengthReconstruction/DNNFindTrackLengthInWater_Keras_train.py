...
## create model
#model = Sequential()
#model.add(Dense(90, input_dim=2203, kernel_initializer='he_uniform', activation='relu'))
...
callbacks_list = [checkpoint]
# Fit the model
#history = model.fit(train_x, train_y, validation_split=0.33, epochs=50, batch_size=2, callbacks=callbacks_list, verbose=0)
