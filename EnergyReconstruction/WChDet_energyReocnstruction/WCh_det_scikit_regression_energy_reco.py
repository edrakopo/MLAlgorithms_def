...
for i in range(1040,1099):
     ...
     chain.Add('/Users/edrakopo/work/work_energy_reco/ener_reco_scikit/nu_numu_'+str(i)+'_CCQE_12in_energy_studies_recoquant_tree_NEWlookupsB_for_training.root')
...
print(arr2_hi_E_n.shape," ",arr3_hi_E.shape," len: ",len(arr2_hi_E_n)," ",len(arr3_hi_E))
arr2_hi_E_n.reshape(-1,1)
arr3_hi_E.reshape(-1,1)
print("B: ",arr2_hi_E_n.shape," ",arr3_hi_E.shape," len: ",len(arr2_hi_E_n)," ",len(arr3_hi_E))
#lasso = Lasso(alpha=0.1)
#coef = lasso.fit(arr2_hi_E_n,arr3_hi_E).coef_
#_ = plt.plot(np.arange(0,5), coef)
##_ = plt.xticks(['total_hits2','total_ring_PEs2','recoDWallR2','recoDWallZ2','lambda_max_2'], arr2_hi_E_n, rotation=60)
