...
def create_model():
    model = Sequential()
    model.add(Dense(100, input_dim=5, init='uniform', activation='tanh'))
...
# optimizer=optimizer, learn_rate=learn_rate, momentum=momentum, init_mode=init_mode, activation=activation, dropout_rate=dropout_rate, weight_constraint=weight_constraint, neurons=neurons)
