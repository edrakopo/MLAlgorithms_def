...
outputFile = ROOT.TFile.Open("scikit_recoLAST.root", "RECREATE")
...
res_twod_SGD_hi_E = np.dstack((test_data_trueKE_hi_E, 100.*(clf_hi_E.predict(test_data_reduced_hi_E_n)-test_data_trueKE_hi_E)/test_data_trueKE_hi_E))
...
for i in range(len(test_data_recoKE_hi_E)):
     outputTuple.Fill(test_data_trueKE_hi_E[i], test_data_neutrinoE_hi_E[i],test_data_recoKE_hi_E[i], test_data_recoKE_hi_E_BDTG[i], test_data_recoKE_hi_E_BDTG_par01[i], test_data_recoKE_hi_E_BDTG_par02[i], recoDwall_data[i], recoToWall_data[i])
 #   outputTuple.Fill(test_data_trueKE_hi_E[i], test_data_recoKE_hi_E[i], test_data_recoKE_hi_E_BDTG[i], test_data_recoKE_hi_E_BDTG2[i], test_data_recoKE_hi_E_BDTG_par0[i], test_data_recoKE_hi_E_BDTG_par1[i], test_data_recoKE_hi_E_BDTG_par2[i], test_data_recoKE_hi_E_BDTG_par3[i], test_data_recoKE_hi_E_BDTG_par4[i], test_data_recoKE_hi_E_BDTG_par5[i],)
...
twod_GBR_abs_hi_E = np.dstack((test_data_trueKE_hi_E, 100.*(net_hi_E.predict(test_data_reduced_hi_E_n)-test_data_trueKE_hi_E)/test_data_trueKE_hi_E))
twod_GBR_abs_hi_E2 = np.dstack((test_data_trueKE_hi_E, 100.*(net_hi_E2.predict(test_data_reduced_hi_E_n)-test_data_trueKE_hi_E)/test_data_trueKE_hi_E))
