...
rfile1 = ROOT.TFile('FINALTMVARegApp_KNN_ener_lilia_CCQE_1040_1100_NEWlookupsTEST_MYselectedVars_large_statTEST10000treesBTEST.root')
...
r_line = mpatches.Patch(fill=False, edgecolor='red', hatch="/", label='KNN')#'TMVA BDT')
...
plt.savefig("TESTMETHODSenergy_resol_muons.png")
#plt.savefig("TESTMETHODSenergy_resol_muonsHE.png")
