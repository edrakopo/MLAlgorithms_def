...
lhcbStyle->SetTitleYOffset(1.);
lhcbStyle->SetTitleXOffset(1.);
// lhcbStyle->SetTitleYSize(0.02)
...
TPaveText *lhcbName = new TPaveText(0.65,0.8,0.9,0.9,"BRNDC");
  // TPaveText *lhcbName = new TPaveText(0.2,0.3,0.45,0.4,"BRNDC");
lhcbName->SetFillColor(0);
lhcbName->SetTextAlign(12);
lhcbName->SetBorderSize(0);
// lhcbName->AddText("LHCb");
 lhcbName->AddText("#splitline{#splitline{LHCb}{Preliminary}}{#scale[0.7]{#sqrt{s} = 7 TeV Data}}");
