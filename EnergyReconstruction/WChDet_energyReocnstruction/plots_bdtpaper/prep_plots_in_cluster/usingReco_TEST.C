...
void usingReco_TEST()
{
  ...
  TH2D *EnerResoBDTG =new TH2D("EnerResoBDTG","Energy Resolution using Scikit BDTG;E_{MC, muon} [MeV]; #Delta E/E [%]",1, 200., 600., 200, -100., 100.);
 ...
 */
 ...
 EnerResoBDTG_pfx_withcuts->Draw("same");
  ...
  TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/EnergyRecoKeras_TEST.root", "RECREATE");
