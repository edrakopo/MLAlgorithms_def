...
*/
  ...
  TH1D *EnerResoBDTG3000 =new TH1D("EnerResoBDTG3000","Energy Resolution using Scikit BDTG; #Delta E/E [%]", 200, -100., 100.);
   ...
   char *fname = Form("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/outputs/FINALTMVARegApp_BDTG_ener_lilia_CCQE_1040_1100_NEWlookupsTEST_MYselectedVars_nue.root");
...
//_______________________________________
 ...
 //plot_emu_LOGE_MLP_diff->Draw(); 
  ...
  //TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorTMVAnue.root", "RECREATE" );
  //TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorTMVAnueINfid.root", "RECREATE" );
  //TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorTITUSnue.root", "RECREATE" );
   TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorTITUSnueINfid.root", "RECREATE" );
