...
*/
  ...
  TH1D *EnerResoBDTG3000 =new TH1D("EnerResoBDTG3000","Energy Resolution using Scikit BDTG; #Delta E/E [%]", 200, -100., 100.);
   ...
   TFile *input(0);  
   //char *fname = Form("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/outputs/FINALTMVARegApp_BDTG_ener_lilia_CCQE_1040_1100_NEWlookupsTEST_MYselectedVars_large_statTEST10000treesB.root");
   char *fname = Form("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/outputs/FINALTMVARegApp_MLP_ener_lilia_CCQE_1040_1100_NEWlookupsTEST_MYselectedVars_large_statTEST10000treesB.root");
  ...
  Float_t trueKE1, neutrinoE, recoE_lookup1, recoKE, recoKE_BDTG, recoKE_BDTG2, recoKE_BDTG_par0, recoKE_BDTG_par1, recoKE_BDTG_par2, recoKE_BDTG_par3, recoKE_BDTG_par4, recoKE_BDTG_par5, recoKE_BDTG01, recoKE_BDTG_par02, recoDWall, recoToWall;
...
//_______________________________________
 ...
 //plot_emu_LOGE_MLP_diff->Draw(); 
  ...
  //TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorTMVA.root", "RECREATE" );
  //TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorTMVAINfid.root", "RECREATE" );
  //TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorTMVAINfid_MLP.root", "RECREATE" );
  TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorTMVA_MLP.root", "RECREATE" );
  //TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorTITUS.root", "RECREATE" );
  //TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorTITUSINfid.root", "RECREATE" );
