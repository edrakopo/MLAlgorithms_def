...
*/
  ...
  TH1D *EnerResoBDTG3000 =new TH1D("EnerResoBDTG3000","Energy Resolution using Scikit BDTG; #Delta E/E [%]", 200, -100., 100.);
   ...
   char *fname = Form("/home/edrakopo/work/ener_reco_scikit/scikit_recoLAST.root");
...
//_______________________________________
 ...
 //plot_emu_LOGE_MLP_diff->Draw(); 
  ...
  //TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorScikit.root", "RECREATE" );
  TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/SigmaErrorScikitINfid.root", "RECREATE" );
