...
void usingReco_scikitEneu()
{
  ...
  TH1D *plot_emu_erecoBDTG= new TH1D("plot_emu_erecoBDTG", "plot_emu_erecoBDTG;#Delta E/E", 200, -1., 1.);
  ...
  TH1D *plot_emu_erecoBDTG_par02= new TH1D("plot_emu_erecoBDTG_par02", "plot_emu_erecoBDTG_par0;#Delta E/E", 200, -1., 1.);
   ...
   TFile *input(0);
    ...
    char *fname = Form("/home/edrakopo/work/ener_reco_scikit/scikit_recoLAST_Eneu.root"); 
  ...
  Float_t neutrinoE, neutrinoE, recoE_lookup, recoKE, recoKE_BDTG, recoKE_BDTG2, recoKE_BDTG_par0, recoKE_BDTG_par1, recoKE_BDTG_par2, recoKE_BDTG_par3, recoKE_BDTG_par4, recoKE_BDTG_par5, recoKE_BDTG01, recoKE_BDTG_par02;
  ...
  */
  ...
  for (Long64_t ievt=0; ievt<regTree->GetEntries();ievt++) {
     ...
     //cout<<"total_ring_PEs2= "<<total_ring_PEs2<<" elut= "<<elut<<" / neutrinoE= "<<neutrinoE<<endl;
     EnerResoLUTs->Fill(neutrinoE, (100*(neutrinoE-recoKE)/neutrinoE));
     EnerResoBDTG->Fill(neutrinoE, (100*(neutrinoE-recoKE_BDTG)/neutrinoE));
     EnerResoBDTG_par01->Fill(neutrinoE, (100*(neutrinoE-recoKE_BDTG01)/neutrinoE));
     EnerResoBDTG_par02->Fill(neutrinoE, (100*(neutrinoE-recoKE_BDTG_par02)/neutrinoE));
  /*   EnerResoBDTG2->Fill(neutrinoE, (100*(neutrinoE-recoKE_BDTG2)/neutrinoE));
     EnerResoBDTG_par0->Fill(neutrinoE, (100*(neutrinoE-recoKE_BDTG_par0)/neutrinoE));
     EnerResoBDTG_par1->Fill(neutrinoE, (100*(neutrinoE-recoKE_BDTG_par1)/neutrinoE));
     EnerResoBDTG_par2->Fill(neutrinoE, (100*(neutrinoE-recoKE_BDTG_par2)/neutrinoE));
     EnerResoBDTG_par3->Fill(neutrinoE, (100*(neutrinoE-recoKE_BDTG_par3)/neutrinoE));
     EnerResoBDTG_par4->Fill(neutrinoE, (100*(neutrinoE-recoKE_BDTG_par4)/neutrinoE));
     EnerResoBDTG_par5->Fill(neutrinoE, (100*(neutrinoE-recoKE_BDTG_par5)/neutrinoE));
*/
     emu_mlp->Fill(neutrinoE,recoKE);

     if(neutrinoE>200. && neutrinoE<600.){ //cout<<"in"<<" DE/E: "<<neutrinoE-recoKE_BDTG/neutrinoE<<endl;
       plot_emu_erecoBDTG->Fill((neutrinoE-recoKE_BDTG)/neutrinoE);
       plot_emu_erecoBDTG_par01->Fill((neutrinoE-recoKE_BDTG01)/neutrinoE);
       plot_emu_erecoBDTG_par02->Fill((neutrinoE-recoKE_BDTG_par02)/neutrinoE);
      /* plot_emu_erecoBDTG2->Fill((neutrinoE-recoKE_BDTG2)/neutrinoE);
       plot_emu_erecoBDTG_par0->Fill((neutrinoE-recoKE_BDTG_par0)/neutrinoE);
       plot_emu_erecoBDTG_par1->Fill((neutrinoE-recoKE_BDTG_par1)/neutrinoE);
       plot_emu_erecoBDTG_par2->Fill((neutrinoE-recoKE_BDTG_par2)/neutrinoE);
       plot_emu_erecoBDTG_par3->Fill((neutrinoE-recoKE_BDTG_par3)/neutrinoE);
       plot_emu_erecoBDTG_par4->Fill((neutrinoE-recoKE_BDTG_par4)/neutrinoE);
       plot_emu_erecoBDTG_par5->Fill((neutrinoE-recoKE_BDTG_par5)/neutrinoE);  */
     }
...
*/
 ...
 TFile* outputFile = new TFile("/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/tmva_ene/EnergyRecoScikitEneu.root", "RECREATE" );
