...
param_grid = {"n_estimators": [400, 600, 1000]}

clf = grid_search.GridSearchCV(net_hi_E,
                               param_grid,
                               cv=5,
                               scoring='neg_mean_squared_error',
                               n_jobs=8)
_ = clf.fit(data_reduced_n, data_target)
...
y_true, y_pred = data_target, clf.decision_function(data_reduced_n)
