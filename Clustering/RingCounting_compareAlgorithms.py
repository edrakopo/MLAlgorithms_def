...
#            print('err3:     %s' \)
    ...
    def kmeans(fig):
        ...
        k_means = cluster.KMeans(init='random', n_clusters=1)
        k_means.fit(X)
        res = k_means.labels_
    ...
    def main():
        #print("I'm in g: ", g)
        #if g<5:
        if i>0 and i<50: #events to be processed
           #print("Y: ",Y)
...
df = pd.DataFrame(total_arr, columns=["Event", "TrueNoRings", "kmeans", "mini_batch", "affinity", "mean_shift", "dbscan"])
df.to_csv("ring_res.csv")
